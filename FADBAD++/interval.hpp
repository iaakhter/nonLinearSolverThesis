...
public:
  ...
  Interval& operator+=
    ...
    {
      _l += c;
      _l = std::nextafter(_l, -std::numeric_limits<double>::infinity());
      _u += c;
      _u = std::nextafter(_u, std::numeric_limits<double>::infinity());
      return *this;
    }
  Interval& operator+=
    ( const Interval&I )
...
{
  Interval I2( std::nextafter(c + I._l, -std::numeric_limits<double>::infinity()), 
                std::nextafter(c + I._u, std::numeric_limits<double>::infinity()));
  return I2;
}
...
{
  Interval I3( std::nextafter(I1._l+I2._l, -std::numeric_limits<double>::infinity()), 
                std::nextafter(I1._u+I2._u, std::numeric_limits<double>::infinity()));
  return I3;
}
...
( const double c, const Interval&I )
{
  Interval I2( std::nextafter(c - I._u, -std::numeric_limits<double>::infinity()), 
                std::nextafter(c - I._l, std::numeric_limits<double>::infinity()));
  return I2;
}
...
( const Interval&I, const double c )
{
  Interval I2( std::nextafter(I._l-c, -std::numeric_limits<double>::infinity()), 
                std::nextafter(I._u-c, std::numeric_limits<double>::infinity()));
  return I2;
}
...
( const Interval&I1, const Interval&I2 )
{
  Interval I3( std::nextafter(I1._l-I2._u, -std::numeric_limits<double>::infinity()), 
                std::nextafter(I1._u-I2._l, std::numeric_limits<double>::infinity()));
  return I3;
}
...
( const double c, const Interval&I )
{
  ...
  Interval newInt(std::nextafter(I2.l(), -std::numeric_limits<double>::infinity()),
                  std::nextafter(I2.u(), std::numeric_limits<double>::infinity()));
  return newInt;
}
...
( const Interval&I1, const Interval&I2 )
{
  ...
  Interval newInt(std::nextafter(I3.l(), -std::numeric_limits<double>::infinity()),
                  std::nextafter(I3.u(), std::numeric_limits<double>::infinity()));
  return newInt;
}
...
{
  int imid = -1;
  return Interval( std::nextafter(mc::sqr( mid(I._l,I._u,0.,imid) ), -std::numeric_limits<double>::infinity()),
                   std::nextafter(std::max(mc::sqr(I._l),mc::sqr(I._u)), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  return Interval( std::nextafter(std::exp(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::exp(I._u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  ...
  return Interval( std::nextafter(std::log(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::log(I._u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  ...
  return Interval( std::nextafter(std::log1p(I.l()), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::log1p(I.u()), std::numeric_limits<double>::infinity()) );
}
...
( const Interval&I )
{
  if ( I._l <= 0. ) throw Interval::Exceptions( Interval::Exceptions::LOG );
  int imid = -1;
  return Interval( std::nextafter(xlog(mid(I._l,I._u,std::exp(-1.),imid)), -std::numeric_limits<double>::infinity()),
                   std::nextafter(std::max(xlog(I._l),xlog(I._u)), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  return Interval( std::nextafter(::erf(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(::erf(I._u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  return Interval( std::nextafter(::erfc(I._u), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(::erfc(I._l), std::numeric_limits<double>::infinity()) );
}
...
( const Interval&I )
{
  ...
  return Interval( std::nextafter(std::sqrt(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::sqrt(I._u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval&I, const int n )
{
  ...
  if( n >= 2 && n%2 == 0 ){ 
    int imid = -1;
    return Interval( std::nextafter(std::pow(mid(I._l,I._u,0.,imid),n), -std::numeric_limits<double>::infinity()),
                     std::nextafter(std::max(std::pow(I._l,n),std::pow(I._u,n)), std::numeric_limits<double>::infinity()) );
  }
  if ( n >= 3 ){
    return Interval( std::nextafter(std::pow(I._l,n), -std::numeric_limits<double>::infinity()), 
                      std::nextafter(std::pow(I._u,n), std::numeric_limits<double>::infinity()) );
  }
  return inv( pow( I, -n ) );
}
...
( const Interval&I, const double a )
{
  if (I.l() <= 0.0 && I.l() >= -1e-100 && I.u() <= 0.0 && I.u() >= -1e-100){
    return Interval(0.0, 0.0);
  }
  if (I.l() <= 0.0 && I.l() >= -1e-100){
    Interval up = Interval(I.u(), I.u());
    Interval upperValInterval = exp(a * log(up));
    return Interval(0.0, std::nextafter(upperValInterval.u(), std::numeric_limits<double>::infinity()));
  }
  return exp( a * log( I ) );
}
...
( const Interval&I )
{
  ...
  if( l <= 0 ){
    if( u <= 0 )   return Interval( std::nextafter(std::cos(l), -std::numeric_limits<double>::infinity()), 
                                    std::nextafter(std::cos(u), std::numeric_limits<double>::infinity()) );
    if( u >= PI )  return Interval( -1., 1. );
    return Interval( std::nextafter(std::min(std::cos(l), std::cos(u)), -std::numeric_limits<double>::infinity()), 1. );
  }
  if( u <= PI )    return Interval( std::nextafter(std::cos(u), -std::numeric_limits<double>::infinity()), 
                                    std::nextafter(std::cos(l), std::numeric_limits<double>::infinity()) );
  if( u >= 2.*PI ) return Interval( -1., 1. );
  return Interval( -1., std::nextafter(std::max(std::cos(l), std::cos(u)), std::numeric_limits<double>::infinity()));
}
...
( const Interval&I )
{
  ...
  return Interval( std::nextafter(std::tan(l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::tan(u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  ...
  return Interval( std::nextafter(std::acos(I._u), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::acos(I._l), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  ...
  return Interval( std::nextafter(std::asin(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::asin(I._u), std::numeric_limits<double>::infinity()) );
}
...
( const Interval &I )
{
  return Interval( std::nextafter(std::atan(I._l), -std::numeric_limits<double>::infinity()), 
                    std::nextafter(std::atan(I._u), std::numeric_limits<double>::infinity()) );
}
